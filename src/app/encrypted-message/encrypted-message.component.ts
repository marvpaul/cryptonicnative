...
@Component({
    selector: "EncryptedMessage",
    moduleId: module.id,
    templateUrl: "./encrypted-message.component.html"
})
export class EncryptedMessageComponent implements OnInit {
    ...
    ngOnInit(): void {
       ...
       this.encryptedText = query['encryptedText']; 
    }
    ...
    copyToClipboard(): void{
        try{
            ...
            clipboard.setText(this.encryptedText).then(function() {
                // show success
            ...
            dialogs.alert("Sorry, something wen't wrong! Please manaully copy the text.").then(()=> {
